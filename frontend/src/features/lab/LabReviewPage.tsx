...
type Attempt = { id: string; status: string; revision: number; updated_at: string; version: number; answers: Record<string, unknown>; teacher_validations: Record<string, Validation>; user: { email: string; display_name?: string }; score?: number; feedback?: string };
