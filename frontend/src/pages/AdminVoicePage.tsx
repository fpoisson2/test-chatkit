...
export const AdminVoicePage = () => {
  ...
  return (
    <ManagementPageLayout tabs={<AdminTabs activeTab="voice" />}>
        ...
        <section className="admin-card">
          <div>
            ...
            <p className="admin-card__subtitle">
              Définissez la voix, le modèle et les instructions envoyées lors de la création d'une session.
            </p>
            {voiceSettings ? (
              <p className="admin-card__subtitle">
              ...
              <div>
                <div className="admin-form__row">
                  <div>
                    ...
                    <p className="admin-card__subtitle">
                      Définissez des couples clé/valeur injectés lors de la création de la session Realtime.
                    </p>
                  </div>
                </div>
                {voiceForm.promptVariables.length === 0 ? (
                  <p className="admin-card__subtitle">Aucune variable définie pour le moment.</p>
                ) : (
