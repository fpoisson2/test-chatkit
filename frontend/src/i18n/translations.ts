...
const fr: TranslationDictionary = {
  ...
  "voiceOverlay.title": "Session vocale",
  "voiceOverlay.subtitle": "Étape : {{title}}",
  "voiceOverlay.subtitleUnknown": "Étape vocale en cours",
  "voiceOverlay.actions.start": "Démarrer la voix",
  "voiceOverlay.actions.stop": "Arrêter",
  "voiceOverlay.actions.requesting": "Demande de permission…",
  "voiceOverlay.status.connecting": "Connexion…",
  "voiceOverlay.status.connected": "Connecté",
  "voiceOverlay.status.error": "Erreur",
  "voiceOverlay.status.idle": "En veille",
  "voiceOverlay.microphone.granted": "Micro autorisé",
  "voiceOverlay.microphone.denied": "Micro refusé",
  "voiceOverlay.microphone.pending": "Micro en attente",
  "voiceOverlay.listenIndicator.active": "En écoute",
  "voiceOverlay.listenIndicator.inactive": "Pause",
  "voiceOverlay.transcripts.title": "Transcriptions",
  "voiceOverlay.transcripts.empty": "Aucune transcription pour le moment.",
  "voiceOverlay.transcripts.assistant": "Assistant",
  "voiceOverlay.transcripts.user": "Utilisateur",
  "voiceOverlay.transcripts.status.completed": "Finalisé",
  "voiceOverlay.transcripts.status.inProgress": "En cours",
  "voiceOverlay.transcripts.status.incomplete": "Incomplet",
  "voiceOverlay.error.unsupported": "La voix n'est pas prise en charge par ce navigateur.",
  "voiceOverlay.error.permissionDenied": "Permission microphone refusée.",
  "voiceOverlay.error.generic": "Impossible de lancer la session vocale.",
...
const en: TranslationDictionary = {
  ...
  "voiceOverlay.title": "Voice session",
  "voiceOverlay.subtitle": "Workflow step: {{title}}",
  "voiceOverlay.subtitleUnknown": "Voice step in progress",
  "voiceOverlay.actions.start": "Start voice",
  "voiceOverlay.actions.stop": "Stop",
  "voiceOverlay.actions.requesting": "Requesting microphone…",
  "voiceOverlay.status.connecting": "Connecting…",
  "voiceOverlay.status.connected": "Connected",
  "voiceOverlay.status.error": "Error",
  "voiceOverlay.status.idle": "Idle",
  "voiceOverlay.microphone.granted": "Microphone allowed",
  "voiceOverlay.microphone.denied": "Microphone denied",
  "voiceOverlay.microphone.pending": "Microphone pending",
  "voiceOverlay.listenIndicator.active": "Listening",
  "voiceOverlay.listenIndicator.inactive": "Paused",
  "voiceOverlay.transcripts.title": "Transcripts",
  "voiceOverlay.transcripts.empty": "No transcripts yet.",
  "voiceOverlay.transcripts.assistant": "Assistant",
  "voiceOverlay.transcripts.user": "User",
  "voiceOverlay.transcripts.status.completed": "Completed",
  "voiceOverlay.transcripts.status.inProgress": "In progress",
  "voiceOverlay.transcripts.status.incomplete": "Incomplete",
  "voiceOverlay.error.unsupported": "Voice sessions are not supported in this browser.",
  "voiceOverlay.error.permissionDenied": "Microphone permission denied.",
  "voiceOverlay.error.generic": "Unable to start the voice session.",
