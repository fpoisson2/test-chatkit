...
const fr: TranslationDictionary = {
  ...
  "workflowBuilder.preview.title": "Prévisualisation",
  "workflowBuilder.preview.overline": "Session de preview",
  "workflowBuilder.preview.enter": "Activer la preview",
  "workflowBuilder.preview.exit": "Quitter la preview",
  "workflowBuilder.preview.toggleLabel": "Basculer le mode preview",
  "workflowBuilder.preview.banner": "Mode preview activé : l'édition du workflow est verrouillée.",
  "workflowBuilder.preview.sessionLoading": "Initialisation de la session de preview…",
  "workflowBuilder.preview.missingSelection": "Sélectionnez un workflow et une version pour lancer la preview.",
  "workflowBuilder.preview.locked": "Mode preview actif : les modifications sont désactivées.",
...
const en: TranslationDictionary = {
  ...
  "workflowBuilder.preview.title": "Preview",
  "workflowBuilder.preview.overline": "Preview session",
  "workflowBuilder.preview.enter": "Enter preview",
  "workflowBuilder.preview.exit": "Exit preview",
  "workflowBuilder.preview.toggleLabel": "Toggle preview mode",
  "workflowBuilder.preview.banner": "Preview mode is on—editing is currently locked.",
  "workflowBuilder.preview.sessionLoading": "Preparing preview session…",
  "workflowBuilder.preview.missingSelection": "Select a workflow and version to start the preview.",
  "workflowBuilder.preview.locked": "Preview mode is active; editing is disabled.",
