...
const fr: TranslationDictionary = {
  ...
  "workflowBuilder.startInspector.telephonySectionDescription":
    "Activez la prise en charge des appels SIP pour ce workflow de démarrage.",
  "workflowBuilder.startInspector.telephonyEntryPointLabel": "Activer la téléphonie entrante",
  "workflowBuilder.startInspector.telephonyEntryPointHelp":
    "Lorsqu'elle est activée, cette définition de workflow sera utilisée pour répondre aux appels SIP entrants.",
...
const en: TranslationDictionary = {
  ...
  "workflowBuilder.startInspector.telephonySectionDescription":
    "Enable SIP routing for this start block.",
  "workflowBuilder.startInspector.telephonyEntryPointLabel": "Use this workflow for incoming calls",
  "workflowBuilder.startInspector.telephonyEntryPointHelp":
    "When enabled, inbound SIP calls will start this workflow directly.",
  "workflowBuilder.createWorkflow.chooseHosted":
