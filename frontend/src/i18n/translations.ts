...
const fr: TranslationDictionary = {
  ...
  "workflowBuilder.repeatZone.create": "Délimiter une boucle",
  "workflowBuilder.repeatZone.edit": "Redessiner la boucle",
  "workflowBuilder.repeatZone.cancel": "Annuler le dessin",
  "workflowBuilder.repeatZone.drawingHint": "Glissez pour encadrer les étapes répétées.",
  "workflowBuilder.repeatZone.zoneLabel": "Zone de répétition",
  "workflowBuilder.repeatZone.remove": "Supprimer la zone de répétition",
  "workflowBuilder.repeatZone.resize.north": "Redimensionner vers le haut",
  "workflowBuilder.repeatZone.resize.south": "Redimensionner vers le bas",
  "workflowBuilder.repeatZone.resize.east": "Redimensionner vers la droite",
  "workflowBuilder.repeatZone.resize.west": "Redimensionner vers la gauche",
  "workflowBuilder.repeatZone.resize.northEast": "Redimensionner en haut à droite",
  "workflowBuilder.repeatZone.resize.northWest": "Redimensionner en haut à gauche",
  "workflowBuilder.repeatZone.resize.southEast": "Redimensionner en bas à droite",
  "workflowBuilder.repeatZone.resize.southWest": "Redimensionner en bas à gauche",
...
const en: TranslationDictionary = {
  ...
  "workflowBuilder.repeatZone.create": "Add loop area",
  "workflowBuilder.repeatZone.edit": "Adjust loop area",
  "workflowBuilder.repeatZone.cancel": "Cancel drawing",
  "workflowBuilder.repeatZone.drawingHint": "Drag to draw the repeating area.",
  "workflowBuilder.repeatZone.zoneLabel": "Repeat zone",
  "workflowBuilder.repeatZone.remove": "Remove repeat zone",
  "workflowBuilder.repeatZone.resize.north": "Resize upward",
  "workflowBuilder.repeatZone.resize.south": "Resize downward",
  "workflowBuilder.repeatZone.resize.east": "Resize to the right",
  "workflowBuilder.repeatZone.resize.west": "Resize to the left",
  "workflowBuilder.repeatZone.resize.northEast": "Resize to the top right",
  "workflowBuilder.repeatZone.resize.northWest": "Resize to the top left",
  "workflowBuilder.repeatZone.resize.southEast": "Resize to the bottom right",
  "workflowBuilder.repeatZone.resize.southWest": "Resize to the bottom left",
  "workflowBuilder.deleteBlock.confirm":
