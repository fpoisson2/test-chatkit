...
const fr: TranslationDictionary = {
  ...
  "voice.workflow.panel.title": "Session vocale en cours",
  "voice.workflow.panel.subtitle":
    "Ce workflow attend une interaction vocale pour l’étape «\u00a0{{step}}\u00a0».",
  "voice.workflow.panel.sessionInfo": "Modèle {{model}} · Voix {{voice}}",
  "voice.workflow.panel.modelUnknown": "modèle inconnu",
  "voice.workflow.panel.voiceUnknown": "voix inconnue",
  "voice.workflow.status.idle": "En veille",
  "voice.workflow.status.connecting": "Connexion en cours",
  "voice.workflow.status.connected": "Connecté",
  "voice.workflow.status.error": "Erreur",
  "voice.workflow.status.listening": "En écoute",
  "voice.workflow.status.paused": "Pause",
  "voice.workflow.microphone.granted": "Micro autorisé",
  "voice.workflow.microphone.denied": "Micro refusé",
  "voice.workflow.microphone.pending": "Micro en attente",
  "voice.workflow.actions.start": "Démarrer l’écoute",
  "voice.workflow.actions.startRequesting": "Demande de permission…",
  "voice.workflow.actions.stop": "Arrêter",
  "voice.workflow.actions.submit": "Envoyer les transcriptions",
  "voice.workflow.actions.submitting": "Envoi…",
  "voice.workflow.actions.dismiss": "Fermer",
  "voice.workflow.actions.clearErrors": "Effacer",
  "voice.workflow.errors.title": "Journal des erreurs",
  "voice.workflow.errors.authRequired": "Authentification requise pour envoyer les transcriptions.",
  "voice.workflow.errors.noSession": "Aucune session vocale active.",
  "voice.workflow.errors.noTranscripts": "Aucune transcription finalisée à envoyer.",
  "voice.workflow.errors.submitUnknown": "Impossible d'envoyer les transcriptions.",
  "voice.workflow.errors.unsupported": "L’accès au microphone n’est pas supporté sur ce navigateur.",
  "voice.workflow.errors.microphoneDenied": "Permission microphone refusée.",
  "voice.workflow.submission.inProgress": "Envoi des transcriptions…",
  "voice.workflow.transcripts.title": "Transcriptions",
  "voice.workflow.transcripts.empty": "Aucune transcription disponible pour le moment.",
  "voice.workflow.transcripts.assistant": "Assistant",
  "voice.workflow.transcripts.user": "Utilisateur",
  "voice.workflow.transcripts.status.completed": "Finalisé",
  "voice.workflow.transcripts.status.inProgress": "En cours",
  "voice.workflow.transcripts.status.incomplete": "Incomplet",
...
const en: TranslationDictionary = {
  ...
  "voice.workflow.panel.title": "Voice session in progress",
  "voice.workflow.panel.subtitle":
    "This workflow is waiting for a voice exchange on step “{{step}}”.",
  "voice.workflow.panel.sessionInfo": "Model {{model}} · Voice {{voice}}",
  "voice.workflow.panel.modelUnknown": "unknown model",
  "voice.workflow.panel.voiceUnknown": "unknown voice",
  "voice.workflow.status.idle": "Idle",
  "voice.workflow.status.connecting": "Connecting",
  "voice.workflow.status.connected": "Connected",
  "voice.workflow.status.error": "Error",
  "voice.workflow.status.listening": "Listening",
  "voice.workflow.status.paused": "Paused",
  "voice.workflow.microphone.granted": "Microphone allowed",
  "voice.workflow.microphone.denied": "Microphone denied",
  "voice.workflow.microphone.pending": "Microphone pending",
  "voice.workflow.actions.start": "Start listening",
  "voice.workflow.actions.startRequesting": "Requesting permission…",
  "voice.workflow.actions.stop": "Stop",
  "voice.workflow.actions.submit": "Submit transcripts",
  "voice.workflow.actions.submitting": "Submitting…",
  "voice.workflow.actions.dismiss": "Close",
  "voice.workflow.actions.clearErrors": "Clear",
  "voice.workflow.errors.title": "Error log",
  "voice.workflow.errors.authRequired": "Sign in to submit transcripts.",
  "voice.workflow.errors.noSession": "No active voice session.",
  "voice.workflow.errors.noTranscripts": "No completed transcripts to submit.",
  "voice.workflow.errors.submitUnknown": "Unable to submit transcripts.",
  "voice.workflow.errors.unsupported": "Microphone access is not supported in this browser.",
  "voice.workflow.errors.microphoneDenied": "Microphone permission denied.",
  "voice.workflow.submission.inProgress": "Submitting transcripts…",
  "voice.workflow.transcripts.title": "Transcripts",
  "voice.workflow.transcripts.empty": "No transcripts yet.",
  "voice.workflow.transcripts.assistant": "Assistant",
  "voice.workflow.transcripts.user": "User",
  "voice.workflow.transcripts.status.completed": "Completed",
  "voice.workflow.transcripts.status.inProgress": "In progress",
  "voice.workflow.transcripts.status.incomplete": "Incomplete",
