...
export const en: TranslationDictionary = {
  ...
  "chatkit.workflow.action.toolCall": "Tool call",
  "chatkit.workflow.action.mcp": "MCP action",
  "chatkit.workflow.action.computerUse": "Computer use",
  "chatkit.workflow.action.clientUi": "Interface action",
