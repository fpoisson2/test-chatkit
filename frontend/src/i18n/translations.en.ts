...
export const en: TranslationDictionary = {
  ...
  "feedback.loading.ariaLabel": "Loading",
  "feedback.loading.page": "Loading page…",
  "feedback.loading.overlayLabel": "Loading in progress",
  "feedback.loading.cancel": "Cancel",
  "styleguide.loaders.title": "Loading states showcase",
  "styleguide.loaders.subtitle": "Preview each loader variant, their translations, and accessibility labels.",
  "styleguide.loaders.section.spinner": "Spinner sizes",
  "styleguide.loaders.section.spinnerDescription": "All three spinner dimensions reuse the same animation timing so you can verify the motion at each scale.",
  "styleguide.loaders.variant.small": "Small spinner",
  "styleguide.loaders.variant.smallDescription": "Use for inline or compact loading indicators.",
  "styleguide.loaders.variant.medium": "Medium spinner",
  "styleguide.loaders.variant.mediumDescription": "Default size for most loading states embedded in cards and panels.",
  "styleguide.loaders.variant.large": "Large spinner",
  "styleguide.loaders.variant.largeDescription": "Use for full page placeholders and dialogs.",
  "styleguide.loaders.spinnerMessage": "Fetching the latest data…",
  "styleguide.loaders.section.overlay": "Overlay",
  "styleguide.loaders.section.overlayDescription": "Trigger the blocking overlay to validate the animation, labels, and cancel interaction in any language.",
  "styleguide.loaders.overlayCardTitle": "Loading overlay",
  "styleguide.loaders.overlayCardSubtitle": "Displays a modal-style loader with a cancel action.",
  "styleguide.loaders.overlayButton": "Show overlay",
  "styleguide.loaders.overlayButtonDisabled": "Overlay visible",
  "styleguide.loaders.overlayHide": "Hide overlay",
  "styleguide.loaders.overlayHint": "Use the cancel button on the overlay or the hide action here to dismiss it.",
  "styleguide.loaders.overlayMessage": "We are getting everything ready…",
  "styleguide.loaders.section.suspense": "Suspense fallback",
  "styleguide.loaders.section.suspenseDescription": "Simulate the Suspense fallback used across lazy routes to ensure the spinner animation and text render correctly.",
  "styleguide.loaders.suspenseTrigger": "Simulate Suspense",
  "styleguide.loaders.suspenseRunning": "Simulation running…",
  "styleguide.loaders.suspenseHelper": "Click the button above to display the Suspense fallback for a short moment.",
