...
export const fr: TranslationDictionary = {
  ...
  "workflowBuilder.agentInspector.jsonSchemaUseTextMode": "Mode texte",
  "workflowBuilder.agentInspector.jsonSchemaUseVisualMode": "Constructeur visuel",
  "workflowBuilder.agentInspector.jsonSchemaBuilderTitle": "Constructeur de schéma",
  "workflowBuilder.agentInspector.jsonSchemaShowPreview": "Afficher l'aperçu JSON",
  "workflowBuilder.agentInspector.jsonSchemaHidePreview": "Masquer l'aperçu JSON",
  "workflowBuilder.agentInspector.jsonSchemaPreview": "Aperçu JSON",
  "workflowBuilder.agentInspector.jsonSchemaAddProperty": "Ajouter une propriété",
  "workflowBuilder.agentInspector.jsonSchemaRequired": "Requis",
  "workflowBuilder.agentInspector.jsonSchemaDescriptionPlaceholder": "Ajouter une description (optionnel)",
  "workflowBuilder.agentInspector.jsonSchemaArrayItems": "Type des éléments du tableau :",
  "workflowBuilder.agentInspector.jsonSchemaExpand": "Développer",
  "workflowBuilder.agentInspector.jsonSchemaCollapse": "Réduire",
  "workflowBuilder.agentInspector.jsonSchemaDeleteProperty": "Supprimer la propriété",
