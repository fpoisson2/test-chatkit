...
export const fr: TranslationDictionary = {
  ...
  "admin.tabs.workflowGeneration": "Generation IA",
  ...
  "admin.workflowGeneration.list.title": "Prompts de generation",
  "admin.workflowGeneration.list.subtitle": "Configurez les prompts utilises pour generer des workflows avec l'IA.",
  "admin.workflowGeneration.list.loading": "Chargement des prompts...",
  "admin.workflowGeneration.list.empty": "Aucun prompt de generation configure. Ajoutez-en un pour utiliser la generation de workflows.",
  "admin.workflowGeneration.list.columns.name": "Nom",
  "admin.workflowGeneration.list.columns.model": "Modele",
  "admin.workflowGeneration.list.columns.effort": "Effort",
  "admin.workflowGeneration.list.columns.verbosity": "Verbosite",
  "admin.workflowGeneration.list.columns.actions": "Actions",
  "admin.workflowGeneration.actions.create": "Ajouter un prompt",
  "admin.workflowGeneration.actions.edit": "Modifier",
  "admin.workflowGeneration.actions.delete": "Supprimer",
  "admin.workflowGeneration.form.createTitle": "Creer un prompt de generation",
  "admin.workflowGeneration.form.editTitle": "Modifier le prompt de generation",
  "admin.workflowGeneration.form.nameLabel": "Nom du prompt",
  "admin.workflowGeneration.form.namePlaceholder": "Ex. Generateur de workflows pedagogiques",
  "admin.workflowGeneration.form.modelLabel": "Modele",
  "admin.workflowGeneration.form.modelPlaceholder": "Ex. o3",
  "admin.workflowGeneration.form.effortLabel": "Niveau d'effort",
  "admin.workflowGeneration.form.effortLow": "Faible",
  "admin.workflowGeneration.form.effortMedium": "Moyen",
  "admin.workflowGeneration.form.effortHigh": "Eleve",
  "admin.workflowGeneration.form.verbosityLabel": "Niveau de verbosite",
  "admin.workflowGeneration.form.verbosityLow": "Faible",
  "admin.workflowGeneration.form.verbosityMedium": "Moyen",
  "admin.workflowGeneration.form.verbosityHigh": "Eleve",
  "admin.workflowGeneration.form.developerMessageLabel": "Message developpeur (prompt systeme)",
  "admin.workflowGeneration.form.developerMessagePlaceholder": "Instructions pour l'IA...",
  "admin.workflowGeneration.form.createSubmit": "Creer le prompt",
  "admin.workflowGeneration.form.updateSubmit": "Enregistrer les modifications",
  "admin.workflowGeneration.confirm.delete": "Supprimer le prompt \"{{name}}\" ?",
  "admin.workflowGeneration.feedback.created": "Prompt \"{{name}}\" cree avec succes.",
  "admin.workflowGeneration.feedback.updated": "Prompt \"{{name}}\" mis a jour avec succes.",
  "admin.workflowGeneration.feedback.deleted": "Prompt \"{{name}}\" supprime.",
  "admin.workflowGeneration.errors.deleteFailed": "Impossible de supprimer le prompt.",
  "admin.workflowGeneration.errors.saveFailed": "Impossible d'enregistrer le prompt.",

  // Workflow Generation Modal
  "workflowGeneration.modal.title": "Generer un workflow avec l'IA",
  "workflowGeneration.modal.promptLabel": "Prompt de generation",
  "workflowGeneration.modal.loadingPrompts": "Chargement des prompts...",
  "workflowGeneration.modal.noPrompts": "Aucun prompt configure. Configurez-en un dans l'administration.",
  "workflowGeneration.modal.userMessageLabel": "Description du workflow a generer",
  "workflowGeneration.modal.userMessagePlaceholder": "Decrivez le workflow que vous souhaitez generer...",
  "workflowGeneration.modal.generate": "Generer",
  "workflowGeneration.modal.starting": "Demarrage...",
  "workflowGeneration.modal.generating": "Generation en cours...",
  "workflowGeneration.modal.statusPending": "En attente",
  "workflowGeneration.modal.statusRunning": "En cours de generation",
  "workflowGeneration.errors.generationFailed": "La generation a echoue.",
  "workflowGeneration.errors.startFailed": "Impossible de demarrer la generation.",
  "workflowGeneration.errors.applyFailed": "Impossible d'appliquer le workflow genere.",

  // Workflow Builder Actions
  "workflowBuilder.actions.generateWorkflow": "Generer avec l'IA",
