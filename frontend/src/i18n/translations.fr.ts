...
export const fr: TranslationDictionary = {
  ...
  "feedback.loading.ariaLabel": "Chargement",
  "feedback.loading.page": "Chargement de la page…",
  "feedback.loading.overlayLabel": "Chargement en cours",
  "feedback.loading.cancel": "Annuler",
  "styleguide.loaders.title": "Aperçu des états de chargement",
  "styleguide.loaders.subtitle": "Visualisez chaque variante de loader, leurs traductions et les libellés d’accessibilité.",
  "styleguide.loaders.section.spinner": "Tailles du spinner",
  "styleguide.loaders.section.spinnerDescription": "Les trois dimensions utilisent la même vitesse d’animation pour vérifier le rendu à chaque échelle.",
  "styleguide.loaders.variant.small": "Petit spinner",
  "styleguide.loaders.variant.smallDescription": "À utiliser pour les indicateurs compacts ou en ligne.",
  "styleguide.loaders.variant.medium": "Spinner moyen",
  "styleguide.loaders.variant.mediumDescription": "Taille par défaut pour les états de chargement dans les cartes et panneaux.",
  "styleguide.loaders.variant.large": "Grand spinner",
  "styleguide.loaders.variant.largeDescription": "À utiliser pour les pages complètes et les boîtes de dialogue.",
  "styleguide.loaders.spinnerMessage": "Récupération des dernières données…",
  "styleguide.loaders.section.overlay": "Overlay",
  "styleguide.loaders.section.overlayDescription": "Déclenchez l’overlay bloquant pour valider l’animation, les libellés et l’action d’annulation dans chaque langue.",
  "styleguide.loaders.overlayCardTitle": "Overlay de chargement",
  "styleguide.loaders.overlayCardSubtitle": "Affiche un loader en mode modal avec une action d’annulation.",
  "styleguide.loaders.overlayButton": "Afficher l’overlay",
  "styleguide.loaders.overlayButtonDisabled": "Overlay affiché",
  "styleguide.loaders.overlayHide": "Masquer l’overlay",
  "styleguide.loaders.overlayHint": "Utilisez le bouton Annuler sur l’overlay ou l’action ci-dessus pour le fermer.",
  "styleguide.loaders.overlayMessage": "Nous préparons tout pour vous…",
  "styleguide.loaders.section.suspense": "Fallback Suspense",
  "styleguide.loaders.section.suspenseDescription": "Simulez le fallback Suspense utilisé sur les routes chargées à la demande pour vérifier l’animation et le texte.",
  "styleguide.loaders.suspenseTrigger": "Simuler Suspense",
  "styleguide.loaders.suspenseRunning": "Simulation en cours…",
  "styleguide.loaders.suspenseHelper": "Cliquez sur le bouton ci-dessus pour afficher brièvement le fallback Suspense.",
  ...
  "workflows.pinAction": "Épingler {{label}}",
  "workflows.unpinAction": "Retirer l'épinglage de {{label}}",
