...
export const fr: TranslationDictionary = {
  ...
  "admin.tabs.github": "Sync GitHub",
  "admin.tabs.telephony": "Téléphonie",
  "admin.tabs.workflowMonitor": "Workflows en cours",
  "admin.tabs.workflowEvaluation": "Évaluation des réponses",
  "admin.tabs.workflowGeneration": "Génération de workflows",
  "admin.tabs.browserTest": "Test navigateur",
  "admin.tabs.settings": "Paramètres généraux",
  "admin.tabs.appearance": "Apparence et thème",
  "admin.tabs.languages": "Langues",
  "admin.tabs.lti": "LTI",
  "admin.tabs.cleanup": "Nettoyage des donnees",
  ...
  "workflowBuilder.agentInspector.modelSelectionModeTitle": "Mode de sélection",
  "workflowBuilder.agentInspector.modelSelectionModeSpecific": "Modèle spécifique",
  "workflowBuilder.agentInspector.modelSelectionModeUserChoice": "Donner le choix à l'utilisateur",
  "workflowBuilder.agentInspector.addModelToList": "Ajouter à la liste",
  "workflowBuilder.agentInspector.userModelOptionsTitle": "Modèles disponibles pour l'utilisateur",
  "workflowBuilder.agentInspector.userModelOptionsDescription": "Ces modèles seront disponibles dans le sélecteur du chat.",
  "workflowBuilder.agentInspector.noUserModelOptions": "Aucun modèle configuré. Sélectionnez un modèle ci-dessus et cliquez sur \"Ajouter à la liste\".",
  "workflowBuilder.agentInspector.defaultModel": "Par défaut",
  "workflowBuilder.agentInspector.removeModel": "Supprimer",
  ...
  "workflowBuilder.agentInspector.promptModal.title": "Prompt système",
  "workflowBuilder.agentInspector.promptModal.expand": "Agrandir",
  "workflowBuilder.agentInspector.promptModal.editMode": "Édition",
  "workflowBuilder.agentInspector.promptModal.previewMode": "Aperçu",
  "workflowBuilder.agentInspector.promptModal.save": "Enregistrer",
  ...
  "workflowBuilder.assistantMessageInspector.publishLive": "Publier en direct",
  "workflowBuilder.assistantMessageInspector.publishLiveTitle": "Mettre à jour ce message dans toutes les conversations actives immédiatement",
  ...
  "workflowBuilder.adminVoice.title": "Assistant vocal",
  "workflowBuilder.adminVoice.description": "Parlez à votre assistant pour gérer les étapes, vérifier la progression des étudiants, et plus.",
  "workflowBuilder.adminVoice.start": "Démarrer",
  "workflowBuilder.adminVoice.stop": "Arrêter",
  "workflowBuilder.adminVoice.connecting": "Connexion...",
  "workflowBuilder.adminVoice.listening": "En écoute...",
  "workflowBuilder.adminVoice.you": "Vous",
  "workflowBuilder.adminVoice.assistant": "Assistant",
  ...
  "workflows.shareAction": "Partager",
  "workflows.share.title": "Partager « {name} »",
  "workflows.share.titleGeneric": "Partager le workflow",
  "workflows.share.emailLabel": "Adresse email",
  "workflows.share.emailPlaceholder": "utilisateur@exemple.com",
  "workflows.share.shareButton": "Partager",
  "workflows.share.sharing": "Partage en cours…",
  "workflows.share.success": "Workflow partagé avec succès.",
  "workflows.share.removed": "Accès révoqué avec succès.",
  "workflows.share.errorGeneric": "Impossible de partager le workflow.",
  "workflows.share.sharedWith": "Partagé avec",
  "workflows.share.remove": "Retirer",
  "workflows.share.removeAccess": "Retirer l'accès pour {email}",
  "workflows.share.noShares": "Ce workflow n'est pas encore partagé.",
  "workflows.share.permissionLabel": "Permission",
  "workflows.share.permissionRead": "Lecture seule",
  "workflows.share.permissionWrite": "Lecture et écriture",
  "workflows.share.changePermission": "Modifier la permission pour {email}",
  "workflows.share.permissionUpdated": "Permission mise à jour avec succès.",
  "workflows.recentSectionTitle": "Récents",
  "workflows.showAll": "Afficher tout",
  "workflows.showLess": "Réduire",
  "workflows.searchEmptyState": "Aucun workflow ne correspond à votre recherche.",
  "sidebar.searchPlaceholder": "Rechercher…",
  "sidebar.searchAriaLabel": "Rechercher des workflows et conversations",
  "sidebar.conversationsTitle": "Conversations",
  "sidebar.conversationsEmpty": "Aucune conversation",
  ...
  "workflowBuilder.actions.createDraft": "Créer une nouvelle version brouillon",
  ...
  "workflowBuilder.github.pushTitle": "Pusher vers GitHub",
  "workflowBuilder.github.pushError": "Impossible de pusher le workflow vers GitHub.",
  "workflowBuilder.github.noRepoSyncs": "Aucun dépôt GitHub configuré.",
  "workflowBuilder.github.configureInAdmin": "Configurez d'abord une synchronisation de dépôt dans le panneau d'administration.",
  "workflowBuilder.github.selectRepo": "Dépôt cible",
  "workflowBuilder.github.filePath": "Chemin du fichier",
  "workflowBuilder.github.patternHint": "Pattern : {{pattern}}",
  "workflowBuilder.github.commitMessage": "Message de commit (optionnel)",
  "workflowBuilder.github.commitPlaceholder": "Mise à jour du workflow : {{name}}",
  "workflowBuilder.github.pushing": "Push en cours…",
  "workflowBuilder.github.push": "Pusher vers GitHub",
  "workflowBuilder.github.pushSuccess": "Workflow pushé vers GitHub avec succès.",
  "workflowBuilder.github.cancel": "Annuler",
  ...
  "workflowBuilder.node.kind.computer_use": "Utilisation de l'ordinateur",
  ...
  // Intégrations GitHub
  "admin.github.integrations.title": "Connexions GitHub",
  "admin.github.integrations.subtitle":
    "Connectez votre compte GitHub pour synchroniser les workflows avec vos dépôts.",
  "admin.github.integrations.loading": "Chargement des connexions GitHub…",
  "admin.github.integrations.empty": "Aucun compte GitHub connecté.",
  "admin.github.integrations.columns.username": "Utilisateur GitHub",
  "admin.github.integrations.columns.scopes": "Permissions",
  "admin.github.integrations.columns.status": "Statut",
  "admin.github.integrations.columns.created": "Connecté",
  "admin.github.integrations.columns.actions": "Actions",
  "admin.github.integrations.status.active": "Actif",
  "admin.github.integrations.status.inactive": "Inactif",
  "admin.github.repoSyncs.title": "Synchronisations de dépôts",
  "admin.github.repoSyncs.subtitle":
    "Configurez quels dépôts et patterns de fichiers synchroniser avec les workflows.",
  "admin.github.repoSyncs.loading": "Chargement des configurations…",
  "admin.github.repoSyncs.empty": "Aucune synchronisation configurée.",
  "admin.github.repoSyncs.emptyNoIntegration":
    "Connectez d'abord un compte GitHub pour configurer les synchronisations.",
  "admin.github.repoSyncs.columns.repo": "Dépôt",
  "admin.github.repoSyncs.columns.pattern": "Pattern de fichiers",
  "admin.github.repoSyncs.columns.direction": "Direction",
  "admin.github.repoSyncs.columns.webhook": "Webhook",
  "admin.github.repoSyncs.columns.lastSync": "Dernière sync",
  "admin.github.repoSyncs.columns.actions": "Actions",
  "admin.github.repoSyncs.branchHint": "Branche : {{branch}}",
  "admin.github.repoSyncs.neverSynced": "Jamais synchronisé",
  "admin.github.repoSyncs.direction.bidirectional": "Bidirectionnel",
  "admin.github.repoSyncs.direction.pull_only": "Pull uniquement (GitHub → EDxo)",
  "admin.github.repoSyncs.direction.push_only": "Push uniquement (EDxo → GitHub)",
  "admin.github.repoSyncs.webhook.enabled": "Activé",
  "admin.github.repoSyncs.webhook.disabled": "Désactivé",
  "admin.github.actions.connect": "Connecter GitHub",
  "admin.github.actions.disconnect": "Déconnecter",
  "admin.github.actions.addRepoSync": "Ajouter une synchronisation",
  "admin.github.actions.edit": "Modifier",
  "admin.github.actions.delete": "Supprimer",
  "admin.github.actions.sync": "Synchroniser",
  "admin.github.actions.syncing": "Synchronisation…",
  "admin.github.actions.enableWebhook": "Activer le webhook",
  "admin.github.actions.disableWebhook": "Désactiver le webhook",
  "admin.github.form.createTitle": "Configurer une synchronisation",
  "admin.github.form.editTitle": "Modifier la synchronisation",
  "admin.github.form.integrationLabel": "Compte GitHub",
  "admin.github.form.selectIntegration": "Sélectionnez un compte",
  "admin.github.form.repoLabel": "Dépôt",
  "admin.github.form.selectRepo": "Sélectionnez un dépôt",
  "admin.github.form.loadingRepos": "Chargement des dépôts…",
  "admin.github.form.branchLabel": "Branche",
  "admin.github.form.patternLabel": "Pattern de fichiers",
  "admin.github.form.patternHint":
    "Pattern glob pour matcher les fichiers workflow (ex. workflows/*.json, **/*-workflow.json)",
  "admin.github.form.directionLabel": "Direction de synchronisation",
  "admin.github.form.autoSyncLabel": "Activer la synchronisation automatique",
  "admin.github.form.saving": "Enregistrement…",
  "admin.github.form.createSubmit": "Créer",
  "admin.github.form.updateSubmit": "Enregistrer",
  "admin.github.oauth.starting": "Connexion à GitHub…",
  "admin.github.oauth.pending": "En attente d'autorisation GitHub…",
  "admin.github.oauth.success": "Compte GitHub connecté avec succès.",
  "admin.github.oauth.errorGeneric": "La connexion à GitHub a échoué.",
  "admin.github.sync.started": "Synchronisation démarrée.",
  "admin.github.sync.completed": "Synchronisation terminée avec succès.",
  "admin.github.sync.failed": "La synchronisation a échoué.",
  "admin.github.confirm.deleteIntegration":
    "Déconnecter le compte GitHub « {{username}} » ? Toutes les configurations de synchronisation seront supprimées.",
  "admin.github.confirm.deleteRepoSync":
    "Supprimer la synchronisation pour « {{repo}} » ?",
  "admin.github.feedback.integrationDeleted":
    "Compte GitHub « {{username}} » déconnecté.",
  "admin.github.feedback.repoSyncCreated": "Configuration de synchronisation créée.",
  "admin.github.feedback.repoSyncUpdated": "Configuration de synchronisation mise à jour.",
  "admin.github.feedback.repoSyncDeleted":
    "Synchronisation pour « {{repo}} » supprimée.",
  "admin.github.feedback.webhookCreated": "Webhook activé avec succès.",
  "admin.github.feedback.webhookDeleted": "Webhook désactivé.",
  "admin.github.errors.sessionExpired": "Session expirée, veuillez vous reconnecter.",
  "admin.github.errors.deleteFailed": "Impossible de supprimer.",
  "admin.github.errors.saveFailed": "Impossible d'enregistrer la configuration.",
  "admin.github.errors.syncFailed": "Impossible de lancer la synchronisation.",
  "admin.github.errors.webhookFailed": "Impossible de gérer le webhook.",
  ...
  "chatkit.thread.closed": "Cette conversation est terminée.",
  "chatkit.thread.locked": "Cette conversation est verrouillée.",
  "chatkit.thread.ltiRestartPrompt": "Cet exercice est terminé. Redémarrer avec un nouveau fil ?",
  "chatkit.thread.ltiRestartAction": "Recommencer l'exercice",
  "chatkit.thread.ltiRestartLoading": "Redémarrage...",
  "chatkit.editMessage.title": "Modifier le message",
  "chatkit.editMessage.close": "Fermer",
  "chatkit.editMessage.description": "Modifiez votre message ci-dessous. Cela créera une nouvelle branche de conversation.",
  "chatkit.editMessage.placeholder": "Saisissez votre message...",
  "chatkit.editMessage.branchNameLabel": "Nom de la branche (optionnel)",
  "chatkit.editMessage.branchNamePlaceholder": "ex. Approche alternative",
  "chatkit.editMessage.cancel": "Annuler",
  "chatkit.editMessage.createBranch": "Créer une branche",
  "chatkit.editMessage.banner": "Modification du message - cela créera une nouvelle branche",
  "chatkit.editMessage.cancelEdit": "Annuler la modification",
  "chatkit.branches.main": "Principale",
  "chatkit.branches.selectBranch": "Sélectionner une branche",
  "chatkit.branches.availableBranches": "Branches disponibles",
  "chatkit.branches.default": "par défaut",
  "chatkit.branches.viewingBranch": "Branche affichée",
  "chatkit.branches.numbered": "Branche #{{number}}",
  "chatkit.message.copy": "Copier",
  "chatkit.message.copied": "Copié",
  "chatkit.code.copy": "Copier le code",
  "chatkit.code.copied": "Copié",
  "chatkit.export.pdf": "Exporter en PDF",
  "chatkit.export.docx": "Exporter en Word",
  "chatkit.export.exporting": "Exportation en cours...",
  ...
  "chatkit.task.type.thought": "Raisonnement",
  "chatkit.task.type.web_search": "Recherche web",
  "chatkit.task.type.file": "Fichiers",
  "chatkit.task.type.image": "Génération d'image",
  "chatkit.task.type.computer_use": "Utilisation de l'ordinateur",
  "chatkit.task.type.shell_call": "Commandes shell",
  "chatkit.task.type.custom": "Workflow",
  "chatkit.task.query": "Requête",
  "chatkit.task.queries": "Requêtes",
  "chatkit.task.sources": "Sources",
  ...
  "admin.browserTest.controls.startUrl": "URL de départ (optionnelle)",
  ...
  "admin.browserTest.info.token": "Jeton de session",
  "admin.browserTest.preview.title": "Aperçu en direct du navigateur",
  "admin.browserTest.preview.description": "Vue en direct de l'écran du navigateur en utilisant le même module de diffusion que celui des tâches computer use dans le chat.",
  "admin.browserTest.preview.hint": "Cliquez dans l'aperçu pour lui donner le focus, puis utilisez directement votre clavier et votre souris. Utilisez \"Démarrer un navigateur neuf\" si vous avez besoin d'une session distincte de celle du chat en cours.",
  ...
  "admin.cleanup.stats.title": "Statistiques des donnees actuelles",
  "admin.cleanup.stats.subtitle": "Apercu des donnees stockees dans le systeme pour tous les utilisateurs.",
  "admin.cleanup.stats.loading": "Chargement des statistiques...",
  "admin.cleanup.stats.error": "Impossible de charger les statistiques. Veuillez reessayer.",
  "admin.cleanup.stats.conversations": "Conversations",
  "admin.cleanup.stats.workflows": "Workflows",
  "admin.cleanup.stats.oldVersions": "Anciennes versions",
  "admin.cleanup.stats.viewports": "Viewports sauvegardes",
  ...
  "admin.cleanup.actions.workflowHistory.description": "Supprime les anciennes versions des workflows, ne conservant que la version active de chaque workflow.",
  "admin.cleanup.actions.workflows.title": "Supprimer tous les workflows",
  "admin.cleanup.actions.workflows.description": "Supprime tous les workflows et leurs versions. Cela cassera toutes les integrations actives.",
  "admin.cleanup.actions.viewports.title": "Supprimer les viewports sauvegardes",
  "admin.cleanup.actions.viewports.description": "Supprime toutes les positions de viewport sauvegardees pour le constructeur de workflows.",
  "admin.cleanup.factoryReset.title": "Reinitialisation d'usine",
  "admin.cleanup.factoryReset.subtitle": "Reinitialiser completement toutes les donnees utilisateur pour repartir de zero.",
  "admin.cleanup.factoryReset.warning": "Cela supprimera definitivement TOUTES les conversations, workflows et viewports. Cette action est irreversible. Les comptes utilisateurs et les parametres systeme seront preserves.",
  "admin.cleanup.factoryReset.button": "Reinitialisation d'usine",
  "admin.cleanup.confirm.confirmButton": "Supprimer",
  "admin.cleanup.confirm.cancelButton": "Annuler",
  "admin.cleanup.confirm.conversations.title": "Supprimer toutes les conversations ?",
  "admin.cleanup.confirm.conversations.message": "Cela supprimera definitivement {{count}} conversations et tous les messages associes. Cette action est irreversible.",
  "admin.cleanup.confirm.workflowHistory.title": "Supprimer l'historique des workflows ?",
  "admin.cleanup.confirm.workflowHistory.message": "Cela supprimera definitivement {{count}} anciennes versions de workflows. Seules les versions actives seront conservees.",
  "admin.cleanup.confirm.workflows.title": "Supprimer tous les workflows ?",
  "admin.cleanup.confirm.workflows.message": "Cela supprimera definitivement {{count}} workflows et toutes leurs versions. Cette action est irreversible.",
  "admin.cleanup.confirm.viewports.title": "Supprimer les viewports sauvegardes ?",
  "admin.cleanup.confirm.viewports.message": "Cela supprimera definitivement {{count}} positions de viewport sauvegardees. Cette action est irreversible.",
  "admin.cleanup.confirm.factoryReset.title": "Reinitialisation d'usine ?",
  "admin.cleanup.confirm.factoryReset.message": "Cela supprimera definitivement TOUTES les conversations, workflows et viewports pour tous les utilisateurs. Cette action est irreversible.",
  "admin.cleanup.success.conversations": "{{count}} conversations supprimees avec succes.",
  "admin.cleanup.success.workflowHistory": "{{count}} anciennes versions de workflows supprimees avec succes.",
  "admin.cleanup.success.workflows": "{{count}} workflows supprimes avec succes.",
  "admin.cleanup.success.viewports": "{{count}} viewports sauvegardes supprimes avec succes.",
