...
export const fr: TranslationDictionary = {
  ...
  "chatkit.workflow.action.toolCall": "Appel d'outil",
  "chatkit.workflow.action.mcp": "Action MCP",
  "chatkit.workflow.action.computerUse": "Contrôle de l'ordinateur",
  "chatkit.workflow.action.clientUi": "Action d'interface",
