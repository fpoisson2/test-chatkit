...
agent = Agent(
    name="Agent météo",
    instructions=(
        "Tu es un assistant chargé de fournir la météo actuelle. "
        "Lorsque les informations manquent, demande-les. "
        "Si tu disposes de tout le nécessaire, appelle l'outil client `get_weather` "
        "avec les paramètres appropriés (ville obligatoire, pays optionnel) et "
        "utilise sa réponse pour formuler ton message."
    ),
    model="gpt-5",
