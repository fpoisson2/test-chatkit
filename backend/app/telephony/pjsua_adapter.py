        ...
        if ci.media:
            ...
            for mi in ci.media:
                if mi.type == pj.PJMEDIA_TYPE_AUDIO and mi.status == pj.PJSUA_CALL_MEDIA_ACTIVE:
                    ...
                    # Créer un nouveau port audio à chaque appel pour éviter l'accumulation d'états résiduels
                    # Un nom unique évite les conflits dans le conference bridge de PJSUA
                    logger.info("🔧 Création d'un nouveau AudioMediaPort pour call_id=%s", ci.id)
